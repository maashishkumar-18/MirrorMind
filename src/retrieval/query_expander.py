...
class ConceptRegistry:
    ...
    def get_acronym(self, term: str) -> str | None:
...
class QueryExpander:
    ...
    def expand(
        ...
        expanded = self._build_expanded_query(query, expanded_with_synonyms, terms_to_add, strategy)
    ...
    def expand_for_pipeline(
        self, query: str, pipeline_name: str, state: ConversationState | None = None
    ) -> ExpandedQuery:
        """
    ...
    def _get_cache_key(self, query: str, state: ConversationState | None, strategy: str) -> str:
    ...
    def _get_context_terms(
        self, state: ConversationState, query_concepts: list[str]
    ...
    def _build_expanded_query(
        self, original: str, acronym_expanded: str, context_terms: list[str], strategy: str
    ) -> str:
    ...
    def _generate_variants(
        self, original: str, expanded: str, keywords: str, strategy: str
    ) -> list[str]:
...
if __name__ == "__main__":
    ...
    for query in test_queries_keywords:
        ...
        print(
            f"   No noise artifacts: {'✅' if 'related' not in result.keywords and 'context' not in result.keywords else '❌'}"
        )
